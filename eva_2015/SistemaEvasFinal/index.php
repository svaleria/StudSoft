...
$result = mysql_fetch_array(mysql_query("select * from estado;", $conectador)); 
//if($result[0]=="OK"){
if(true){
echo '<script> window.location="vista/index.html"; </script>';
} else{
echo "BIENVENIDO AL INSTALADOR DE 'DOCEBITO' EL SISTEMA PARA EVALUAR EN LINEA. <P> ANTES DE CONTINUAR CON LA INSTALACION 
TOMESE TIEMPO PARA LEER LAS CONDICIONES DE USO:<p><p>
<textarea id='licencia' readonly='sololectura' name='licencia' cols='72' rows='20'>
...
</textarea><p><form id='form1' name='form1' method='post' action='panelInstalador.php'>
          <input type='submit' name='button' id='button' value='Acepto las condiciones y continuo...'/>
          </form>";
}
?>